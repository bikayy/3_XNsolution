...
namespace Team5_XN
{
    public partial class frmSiyuOrder : Form
    {
        ...
        private void LoadOrder(PlanSearchVO ps)
        {  //Wo_Status, WorkOrderNo, Plan_Date, Plan_Qty_Box, Item_Code, Wc_Code,
            ...
            listOrder = orderServ.SelectOrder(ps);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            TextBox[] textboxes = { p_txtPlanNo, o_txtItemName, p_txtCustomer, o_txtWCName, o_txtOrderQty};
            Label[] labels = { p_lblPlanNo, o_lblItem, p_lblCustomer, o_lblWC, o_lblOrderQty};
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (orResult) MessageBox.Show("작업지시가 생성되었습니다.");
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (orResult) MessageBox.Show("작업지시가 수정되었습니다.");
