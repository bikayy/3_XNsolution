...
namespace Team5_XN_DAC
{
    public class OrderDAC : IDisposable
    {
        ...
        public List<OrderVO> SelectOrder(string planNo)
        {  //Wo_Status, WorkOrderNo, Plan_Date, Plan_Qty_Box, Item_Code, Wc_Code,
           ...
           //Prd_Plan_No, Ins_Date, Ins_Emp, Up_Date, Up_Emp
            ...
            cmd.Parameters.AddWithValue("@Prd_Plan_No", planNo);
        ...
        public bool DeleteOrder(string no)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = conn;
            ...
            cmd.Parameters.AddWithValue("@WorkOrderNo", no);
